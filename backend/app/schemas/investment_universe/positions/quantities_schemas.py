...
class QuantityDataPoint(BaseModel):
    """Single quantity data point"""
    date: datetime = Field(..., description="Quantity timestamp")
    symbol: str = Field(..., description="Trading symbol")
    quantity: float = Field(..., description="Quantity held in base asset", ge=0)
...
class QuantitiesResponse(APIResponse):
    ...
    data: List[QuantityDataPoint] = Field(..., description="Quantity data for requested assets")
